...
import AdminCodeManager from "@/app/components/admin-code-manager";
    ...
    <div className="min-h-screen bg-[var(--background)] px-5 py-10">
      <div className="mx-auto max-w-3xl">
          ...
          <button
            ...
            className={`rounded-xl px-5 py-2 text-sm font-medium transition ${
              activeTab === "content"
                ...
                : "bg-white ring-1 ring-[var(--pink-soft)] text-[var(--foreground)]/70 hover:text-[var(--pink-deep)]"
            }`}
          >
            网站内容
          </button>
        ...
        {activeTab === "content" ? (
          ...
          <AdminCodeManager adminPassword={localStorage.getItem("admin-password") || password} />
        )}
      </div>
    </div>
  );
