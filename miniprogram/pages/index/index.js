const content = {
  ...
  services: [
    ...
    { en: "PLUS", zh: "进阶色彩测试", desc: "在八季型基础上细分，色彩判断更精准。", duration: "1小时", price: { COCO: 998, 乐飞: 799 } },
    ...
    { en: "WEDDING", zh: "婚礼诊断", desc: "将色彩诊断、骨骼体型诊断与婚礼场景美学结合，为新娘定制专属婚礼形象方案。", duration: "1小时", price: { COCO: 1098 } }
  ],
  details: [
    {
      en: "BASIC",
