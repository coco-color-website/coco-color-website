const content = {
  ...
  services: [
    { en: "BASIC", zh: "基础色彩测试", desc: "经典八季型定基调，快速了解自身适配色。", duration: "40分钟", price: { COCO: 699, 乐飞: 599 } },
    { en: "PLUS", zh: "进阶色彩测试", desc: "在八季型基础上细分，色彩判断更精准。", duration: "1小时", price: { COCO: 899, 乐飞: 799 } },
    { en: "ADVANCED", zh: "高阶色彩测试", desc: "二十一季型深度诊断，全维度色彩适配。", duration: "1.5小时", price: { COCO: 1098 } },
    { en: "BODY", zh: "骨骼体型诊断", desc: "分析骨骼与体型，定制整体形象设计方案。", duration: "1小时", price: { COCO: 1098 } },
    { en: "WEDDING", zh: "婚礼诊断", desc: "将色彩诊断、骨骼体型诊断与婚礼场景美学结合，为新娘定制专属婚礼形象方案。", duration: "1小时", price: { COCO: 1198 } }
  ],
  details: [
    {
      en: "BASIC",
